> PDF location: https://github.com/soniqo/speech-core (no source.pdf fetched; see Source field below)
# soniqo/speech-core
Source: https://github.com/soniqo/speech-core
Kind: repo
Fetched: 2026-09-22T14:46:27.463538+00:00
Tool: git-clone

# soniqo/speech-core

Commit: f0050757a7d7d24c60b17e60016989ecd07a491d
...
... (truncated, 1963 more characters)

## Top-level layout

- .gitattributes (~4 lines)
- .github/ (dir, 6 files, ~1497 lines)
- .gitignore (~35 lines)
- AGENTS.md (~157 lines)
- CLAUDE.md (~157 lines)
- CMakeLists.txt (~1377 lines)
- CODEX.md (~157 lines)
- docs/ (dir, 9 files, ~3223 lines)
- examples/ (dir, 41 files, ~6271 lines)
- include/ (dir, 90 files, ~9795 lines)
- LICENSE (~190 lines)
- README.md (~240 lines)
- README.zh-CN.md (~3 lines)
- README_ar.md (~263 lines)
- README_de.md (~228 lines)
- README_es.md (~228 lines)
- README_fr.md (~228 lines)
- README_hi.md (~223 lines)
- README_ja.md (~240 lines)
- README_ko.md (~240 lines)
- README_pt.md (~223 lines)
- README_ru.md (~223 lines)
- README_th.md (~223 lines)
- README_tr.md (~223 lines)
- README_vi.md (~223 lines)
- README_zh.md (~240 lines)
- scripts/ (dir, 21 files, ~3163 lines)
- src/ (dir, 89 files, ~35701 lines)
- tests/ (dir, 83 files, ~22577 lines)
- THIRD-PARTY-NOTICES.md (~103 lines)
- third_party/ (dir, 60 files, ~56172 lines)
