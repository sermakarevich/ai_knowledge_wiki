> PDF location: https://github.com/kyutai-labs/moshi (no source.pdf fetched; see Source field below)
# kyutai-labs/moshi
Source: https://github.com/kyutai-labs/moshi
Kind: repo
Fetched: 2026-09-22T14:18:23.462180+00:00
Tool: git-clone
...
... (truncated, 2420 more characters)

## Top-level layout

- .dockerignore (~1 lines)
- .github/ (dir, 8 files, ~436 lines)
- .gitignore (~187 lines)
- .pre-commit-config.yaml (~34 lines)
- client/ (dir, 84 files, ~10346 lines)
- configs/ (dir, 5 files, ~225 lines)
- CONTRIBUTING.md (~57 lines)
- data/ (dir, 4 files, ~2 lines)
- deploy.sh (~7 lines)
...
- mimi.png (~0 lines)
- moshi/ (dir, 52 files, ~9757 lines)
- moshi.png (~0 lines)
- moshi_mlx/ (dir, 29 files, ~5585 lines)
- README.md (~296 lines)
- requirements-dev.txt (~3 lines)
- rust/ (dir, 70 files, ~25341 lines)
- scripts/ (dir, 23 files, ~2853 lines)
- swarm-config.yml (~116 lines)