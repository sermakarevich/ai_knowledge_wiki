...
> PDF location (no local PDF): https://github.com/Ankur2606/Low-latency-AI-Voice-Assistant
Source: https://github.com/Ankur2606/Low-latency-AI-Voice-Assistant
Kind: repo
Fetched: 2026-09-22T14:16:58.798962+00:00
Tool: git-clone

# Ankur2606/Low-latency-AI-Voice-Assistant

Commit: 3ae4b73746e03690002fa3dd3b27046f4c87d71a
...
- LICENSE (~21 lines)
- main.py (~67 lines)
- Models/ (dir, 3 files, ~281 lines)
- packages.txt (~5 lines)
- README.md (~153 lines)
- requirements.txt (~13 lines)
- Testing/ (dir, 11 files, ~1447 lines)
- utils/ (dir, 4 files, ~166 lines)
