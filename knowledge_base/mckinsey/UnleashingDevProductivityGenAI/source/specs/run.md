...
4. `bd close <your-own-id> --reason "research/UnleashingDevProductivityGenAI McKinsey get_local done"`.
...
(b) Source unfetchable: `git add /Users/sergii/.ai/knowledge/structured_papers/mckinsey/UnleashingDevProductivityGenAI/UnleashingDevProductivityGenAI/source/fetch_blocked.md`, commit
    ...
    `bd close <your-own-id> --reason "research/UnleashingDevProductivityGenAI BLOCKED: McKinsey fetch failed on all routes"`.
