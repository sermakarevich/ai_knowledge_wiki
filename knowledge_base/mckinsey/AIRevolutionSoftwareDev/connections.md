# Connections — The AI revolution in software development

- `knowledge/structured_papers/mckinsey/UnlockingAIValueSoftwareDev/UnlockingAIValueSoftwareDev/` — sibling McKinsey get_local on the same theme: survey evidence (15-point quintile gap, 16–30% / 31–45% ranges) for the overhaul thesis this article argues by showcase case.
- `knowledge/structured_papers/mckinsey/AIProcurementAgenticEra/` — sibling McKinsey get_local on agentic rewiring of a neighboring function; same restructure-don't-bolt-on moral applied to procurement.
