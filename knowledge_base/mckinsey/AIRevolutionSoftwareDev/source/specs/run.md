...
**Article:** [The AI revolution in software development](https://www.mckinsey.com/capabilities/tech-and-ai/our-insights/the-ai-revolution-in-software-development)
...
4. `bd close <your-own-id> --reason "papers/AIRevolutionSoftwareDev McKinsey get_local done"`.
...
(b) Source unfetchable: `git add /Users/sergii/.ai/knowledge/structured_papers/mckinsey/AIRevolutionSoftwareDev/AIRevolutionSoftwareDev/source/fetch_blocked.md`, commit
    ...
    `bd close <your-own-id> --reason "papers/AIRevolutionSoftwareDev BLOCKED: McKinsey fetch failed on all routes"`.
