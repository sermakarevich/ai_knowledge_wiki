...
4. `bd close <your-own-id> --reason "papers/GenAINextInflectionPoint McKinsey get_local done"`.
...
(b) Source unfetchable: `git add /Users/sergii/.ai/knowledge/structured_papers/mckinsey/GenAINextInflectionPoint/GenAINextInflectionPoint/source/fetch_blocked.md`, commit
    ...
    `bd close <your-own-id> --reason "papers/GenAINextInflectionPoint BLOCKED: McKinsey fetch failed on all routes"`.
