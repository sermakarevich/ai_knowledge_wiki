...
## Fix
1. Read ONLY `/Users/sergii/.ai/knowledge/structured_papers/mckinsey/AgenticOrganization/digest.md`.
...
## Tests
- `grep -c "five moves" /Users/sergii/.ai/knowledge/structured_papers/mckinsey/AgenticOrganization/digest.md` >= 1; markers still present.
