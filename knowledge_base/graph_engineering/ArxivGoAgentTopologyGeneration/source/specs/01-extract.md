...
- `/Users/sergii/.ai/knowledge/research/ArxivGoAgentTopologyGeneration/source/chunks/01.txt` — extracted paper text: title/authors/abstract, Section 1 Introduction, Section 2 Preliminaries (2.1 Problem Formulation, 2.2 Information Bottleneck)
- `/Users/sergii/.ai/knowledge/research/ArxivGoAgentTopologyGeneration/wiki/images/01-description.md` — a vision-model description of Figure 1 (node-centric vs. group-centric paradigm comparison)

**Output:** `/Users/sergii/.ai/knowledge/research/ArxivGoAgentTopologyGeneration/wiki/01-problem-and-motivation.md`
...
## DoD
1. `/Users/sergii/.ai/knowledge/research/ArxivGoAgentTopologyGeneration/wiki/01-problem-and-motivation.md` written per the contract above.
