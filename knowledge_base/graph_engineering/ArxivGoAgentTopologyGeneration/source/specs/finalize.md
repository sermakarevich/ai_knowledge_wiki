...
Read the 4 wiki pages (small now, ~100-200 lines each) — not the raw source, except to spot-check quality if something looks off. Produce, per `ai show summary/get` conventions:
