...
Folder: `/Users/sergii/.ai/knowledge/papers/LangGraph3YearsGraphEngineering/`
...
Read the 4 wiki pages (not the raw source, except to spot-check). Produce, per `ai show summary/get` conventions (Article source type, content track, `papers/` base — no date prefix):
...
- `connections.md` — read `/Users/sergii/.ai/knowledge/structured_papers/index.md` and skim 2-3 plausible category files, plus `ls /Users/sergii/.ai/knowledge/papers/`, for genuinely related entries (agentic systems, multi-agent orchestration, LangGraph/LangChain, loop engineering). Select 2-6 genuinely related entries, or state none found.
...
- Do not touch any other source's folder under `/Users/sergii/.ai/knowledge/papers/` or `/Users/sergii/.ai/knowledge/investment/`.
