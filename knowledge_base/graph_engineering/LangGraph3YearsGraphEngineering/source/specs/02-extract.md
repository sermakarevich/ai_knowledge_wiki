# Extract wiki page: 02-when-not-to-use-graphs
...
## Input
Read ONLY this file: `/Users/sergii/.ai/knowledge/research/LangGraph3YearsGraphEngineering/source/chunks/02.txt`
...
## Output
Write exactly this file (create parent dirs if needed): `/Users/sergii/.ai/knowledge/research/LangGraph3YearsGraphEngineering/wiki/02-when-not-to-use-graphs.md`
...
<full detail prose covering: why some tasks resist deterministic graph paths, the Deep Agents alternative, the deep-research example, and the GPT Researcher example of moving away from a graph-shaped pipeline>
...
- This chunk is short — do not pad it with invented content; write concisely but cover every point made (including the GPT Researcher example).
