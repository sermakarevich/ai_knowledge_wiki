...
all of them (same spec file, `--cwd /Users/sergii/.ai --coder claude --model sonnet -p 1
...
Read `ai show summary/get` (Shared Output Conventions section) for the exact file specs,
