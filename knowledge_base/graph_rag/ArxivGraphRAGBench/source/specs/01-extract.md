...
`/Users/sergii/.ai/knowledge/research/ArxivGraphRAGBench/source/chunks/01.txt`
...
`/Users/sergii/.ai/knowledge/research/ArxivGraphRAGBench/wiki/images/fig1-description.md`

The actual image file already exists at `/Users/sergii/.ai/knowledge/research/ArxivGraphRAGBench/wiki/images/fig1-overview.png` — embed it in your page using the description to write accurate surrounding text; you do not need to view the image yourself.

## Output

Write the wiki page to this exact path (if it already exists — a retry — overwrite it completely):

`/Users/sergii/.ai/knowledge/research/ArxivGraphRAGBench/wiki/01-introduction-and-motivation.md`
