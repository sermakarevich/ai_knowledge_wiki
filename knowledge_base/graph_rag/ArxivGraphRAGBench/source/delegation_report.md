...
Synthesized `index.md`, `summary.md`, `digest.md`, `explainer.md`, `questions.md`, `critical_thinking.md`, `connections.md` from the verified wiki pages. `connections.md` links to 4 related, already-finalized entries in `structured_papers/graph_rag/` (HippoRAG, LightRAG, GraphRAG local-to-global, GraphRAG survey — all methods/taxonomy directly referenced by this paper); 5 other GraphRAG-adjacent KB entries were still mid-ingestion and were noted but not linked.
