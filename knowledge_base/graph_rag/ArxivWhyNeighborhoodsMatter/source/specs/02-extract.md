...
1. Read ONLY these files (nothing else):
   - `/Users/sergii/.ai/knowledge/research/ArxivWhyNeighborhoodsMatter/source/chunks/02.txt` (the section text)
   - `/Users/sergii/.ai/knowledge/research/ArxivWhyNeighborhoodsMatter/wiki/images/01-description.md` (description of Figure 1)
   - `/Users/sergii/.ai/knowledge/research/ArxivWhyNeighborhoodsMatter/wiki/images/02-description.md` (description of Figure 2)
2. Write the wiki page to: `/Users/sergii/.ai/knowledge/research/ArxivWhyNeighborhoodsMatter/wiki/02-experimental-design-and-studies.md`
...
## Tests
- `test -s /Users/sergii/.ai/knowledge/research/ArxivWhyNeighborhoodsMatter/wiki/02-experimental-design-and-studies.md`
...
## DoD
1. `/Users/sergii/.ai/knowledge/research/ArxivWhyNeighborhoodsMatter/wiki/02-experimental-design-and-studies.md` written per the structure above.
2. No git commands — this repo auto-syncs.
3. `bd close <own-id> --reason "chunk 02 extracted"` — never exit rc=0 without closing.

## Scope & constraints
- Touch ONLY `/Users/sergii/.ai/knowledge/research/ArxivWhyNeighborhoodsMatter/wiki/02-experimental-design-and-studies.md`.
