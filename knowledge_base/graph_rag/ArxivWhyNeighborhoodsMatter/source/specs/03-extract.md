...
## Fix
1. Read ONLY this file: `/Users/sergii/.ai/knowledge/research/ArxivWhyNeighborhoodsMatter/source/chunks/03.txt`
   (plain text, one section of the paper). Do not read any other file.
2. Write the wiki page to: `/Users/sergii/.ai/knowledge/research/ArxivWhyNeighborhoodsMatter/wiki/03-results-and-discussion.md`
...
## Tests
- `test -s /Users/sergii/.ai/knowledge/research/ArxivWhyNeighborhoodsMatter/wiki/03-results-and-discussion.md`
- The file contains `**In one sentence:**` and `## Key points`

## DoD
1. `/Users/sergii/.ai/knowledge/research/ArxivWhyNeighborhoodsMatter/wiki/03-results-and-discussion.md` written per the structure above.
2. No git commands — this repo auto-syncs.
3. `bd close <own-id> --reason "chunk 03 extracted"` — never exit rc=0 without closing.

## Scope & constraints
- Touch ONLY `/Users/sergii/.ai/knowledge/research/ArxivWhyNeighborhoodsMatter/wiki/03-results-and-discussion.md`.
