...
`/Users/sergii/.ai/knowledge/research/ArxivWhyNeighborhoodsMatter/`. Four extract beads (one per section) write
...
- **Attempt count < 3:** delete the bad wiki file, create ONE retry extract bead reusing
  ...
  /Users/sergii/.ai -p 2 -t task --body-file /Users/sergii/.ai/knowledge/research/ArxivWhyNeighborhoodsMatter/source/specs/NN-extract.md`.
  Record its id.
...
## Tests
- `ls /Users/sergii/.ai/knowledge/research/ArxivWhyNeighborhoodsMatter/` shows `index.md summary.md digest.md
  explainer.md questions.md critical_thinking.md connections.md source/ wiki/`
- `grep -c "In one sentence" /Users/sergii/.ai/knowledge/research/ArxivWhyNeighborhoodsMatter/digest.md` → 4
...
## Scope & constraints
- Touch ONLY files under `/Users/sergii/.ai/knowledge/research/ArxivWhyNeighborhoodsMatter/` and beads you create
