...
- `/Users/sergii/.ai/knowledge/research/ArxivGraphPlanner/source/chunks/02.txt`
...
- `/Users/sergii/.ai/knowledge/research/ArxivGraphPlanner/wiki/images/fig2-graphplanner-mdp-overview-description.md`

The actual image file already exists at `/Users/sergii/.ai/knowledge/research/ArxivGraphPlanner/wiki/images/fig2-graphplanner-mdp-overview.png` — you do not need to view it, just embed it at the right point using the markdown syntax below.

## Output

Write the wiki page to:
- `/Users/sergii/.ai/knowledge/research/ArxivGraphPlanner/wiki/02-graphplanner-method.md`
