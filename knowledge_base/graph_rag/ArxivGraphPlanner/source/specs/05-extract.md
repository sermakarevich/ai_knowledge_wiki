...
- `/Users/sergii/.ai/knowledge/research/ArxivGraphPlanner/source/chunks/05.txt`
...
- `/Users/sergii/.ai/knowledge/research/ArxivGraphPlanner/wiki/images/fig6-illustrative-workflow-examples-description.md`

The actual image file already exists at `/Users/sergii/.ai/knowledge/research/ArxivGraphPlanner/wiki/images/fig6-illustrative-workflow-examples.png` — you do not need to view it, just embed it at the right point using the markdown syntax below.

## Output

Write the wiki page to:
- `/Users/sergii/.ai/knowledge/research/ArxivGraphPlanner/wiki/05-additional-ablations-and-generalization.md`
