# Extract task: Training Strategies, Downstream Tasks & Evaluation
...
**Input:** Read the chunk text at `/Users/sergii/.ai/knowledge/research/ArxivGraphRAGSurvey/source/chunks/06.txt` (extracted markdown text from pages of the paper's PDF, covering: Sec 8 Training; Sec 9 Applications and Evaluation).

**Output:** Write the wiki page to `/Users/sergii/.ai/knowledge/research/ArxivGraphRAGSurvey/wiki/06-training-applications-evaluation.md`.
...
Topic for this page: **Training Strategies, Downstream Tasks & Evaluation**
Section(s) covered: Sec 8 Training; Sec 9 Applications and Evaluation

## Figures for this section

Image file: `images/fig6-graph-languages-19.png` (already extracted; embed it at the point in the text that discusses it)
...
**If `/Users/sergii/.ai/knowledge/research/ArxivGraphRAGSurvey/wiki/06-training-applications-evaluation.md` already exists (this is a retry), overwrite it completely.**

## Tests

- `test -f /Users/sergii/.ai/knowledge/research/ArxivGraphRAGSurvey/wiki/06-training-applications-evaluation.md` succeeds
- `wc -l /Users/sergii/.ai/knowledge/research/ArxivGraphRAGSurvey/wiki/06-training-applications-evaluation.md` reports more than 40 lines
- `grep -c "In one sentence" /Users/sergii/.ai/knowledge/research/ArxivGraphRAGSurvey/wiki/06-training-applications-evaluation.md` reports 1
- `grep -c "## Key points" /Users/sergii/.ai/knowledge/research/ArxivGraphRAGSurvey/wiki/06-training-applications-evaluation.md` reports 1

## DoD

1. `/Users/sergii/.ai/knowledge/research/ArxivGraphRAGSurvey/wiki/06-training-applications-evaluation.md` is written per the format contract above, covering the ENTIRE chunk (including its last subsections, not just the opening).
2. No git commands at all -- `.ai` auto-syncs on its own schedule.
3. `bd close <own-id> --reason "chunk 06 extracted"` -- never exit rc=0 without closing.

## Scope & constraints

- Touch ONLY `/Users/sergii/.ai/knowledge/research/ArxivGraphRAGSurvey/wiki/06-training-applications-evaluation.md`. Do not edit any other file.
