...
_Note: two related in-progress entries — `ArxivGraphRAGBench` and `ArxivRAGvsGraphRAG` — exist under `/Users/sergii/.ai/knowledge/papers/` but have no `summary.md` yet (still mid-pipeline), so they are not linked here._
