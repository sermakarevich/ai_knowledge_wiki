...
Folder: `/Users/sergii/.ai/knowledge/research/ArxivGraphRAGLinkedInCustomerService/`
...
- Create a successor finalize bead: `fleet bd create "ArxivGraphRAGLinkedInCustomerService finalize: verify + synthesize" --cwd /Users/sergii/.ai --coder claude --model sonnet -p 1 -t task --body-file /Users/sergii/.ai/knowledge/research/ArxivGraphRAGLinkedInCustomerService/source/specs/finalize.md --deps "<the still-open bead ids>" --silent`
...
- Attempt count < 3: delete the bad wiki page file, create ONE retry extract bead reusing
  ...
  `fleet bd create "ArxivGraphRAGLinkedInCustomerService chunk NN extract retry" --cwd /Users/sergii/.ai --coder opencode --model ollama-rtx/qwen3.8:27b -p 2 -t task --body-file /Users/sergii/.ai/knowledge/research/ArxivGraphRAGLinkedInCustomerService/source/specs/NN-extract.md --silent`
  Record its id.
