# Extract task — SAGE paper, chunk 05

Topic: Appendix C-G (target graph calibration, distribution shift, reader stability under dynamic graph evolution, theoretical motivation of writer-reader loop, writer analysis)
...
`/Users/sergii/.kb/papers/ArxivSAGEGraphMemory/source/chunks/05.txt`

## Figure description file(s) for this chunk

- Image: `/Users/sergii/.kb/papers/ArxivSAGEGraphMemory/wiki/images/05-fig5-scaling.png` (embed as `![...](images/05-fig5-scaling.png)`)
- Vision description (read this to write the caption/discussion): `/Users/sergii/.kb/papers/ArxivSAGEGraphMemory/wiki/images/05-fig5-scaling-description.md`

## Output

Write the wiki page to:

`/Users/sergii/.kb/papers/ArxivSAGEGraphMemory/wiki/05-appendix-calibration-stability-theory.md`
