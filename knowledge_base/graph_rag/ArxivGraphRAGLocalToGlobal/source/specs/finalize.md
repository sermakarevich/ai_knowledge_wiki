...
Per `ai show summary/get` conventions, produce (reading the wiki pages — small now — not the raw source, except to spot-check quality against `source/graphrag_2404.16130.pdf` or the chunk texts if something seems off):
