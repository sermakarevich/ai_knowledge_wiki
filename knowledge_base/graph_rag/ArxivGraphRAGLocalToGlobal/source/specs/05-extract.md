...
- Source text chunk: `/Users/sergii/.ai/knowledge/research/ArxivGraphRAGLocalToGlobal/source/chunks/05.txt`
...
- Figure descriptions: `/Users/sergii/.ai/knowledge/research/ArxivGraphRAGLocalToGlobal/wiki/images/03-hotpotqa-description.md` (for Figure 3) and `/Users/sergii/.ai/knowledge/research/ArxivGraphRAGLocalToGlobal/wiki/images/04-communities-description.md` (for Figure 4)
- The figure images already exist at `/Users/sergii/.ai/knowledge/research/ArxivGraphRAGLocalToGlobal/wiki/images/03-hotpotqa-figure3.png` and `/Users/sergii/.ai/knowledge/research/ArxivGraphRAGLocalToGlobal/wiki/images/04-communities-figure4.png` — do not create or move them, just reference them by relative path in your embeds.

## Output

Write to: `/Users/sergii/.ai/knowledge/research/ArxivGraphRAGLocalToGlobal/wiki/05-appendix-prompts-and-additional-experiments.md`
...
1. `/Users/sergii/.ai/knowledge/research/ArxivGraphRAGLocalToGlobal/wiki/05-appendix-prompts-and-additional-experiments.md` written per the format contract above, covering the entire chunk.
