# PatterAI/Patter
Source: https://github.com/PatterAI/Patter
Kind: repo
Fetched: 2026-09-22T14:32:02.225767+00:00
Tool: git-clone
PDF: https://github.com/PatterAI/Patter

# PatterAI/Patter

Commit: f01875136816c953151a0e61dcf3a0057027b2b4
...
- .githooks/ (dir, 1 files, ~45 lines)
- .github/ (dir, 10 files, ~822 lines)
- .gitignore (~43 lines)
- .nvmrc (~1 lines)
- .pre-commit-config.yaml (~69 lines)
- .python-version (~1 lines)
- AGENTS.md (~67 lines)
- CHANGELOG.md (~3282 lines)
- CONTRIBUTING.md (~117 lines)
- create-getpatter/ (dir, 4 files, ~356 lines)
- dashboard-app/ (dir, 34 files, ~7354 lines)
- docker-compose.yml (~7 lines)
- Dockerfile (~15 lines)
- docs/ (dir, 158 files, ~26540 lines)
- examples/ (dir, 21 files, ~774 lines)
- libraries/ (dir, 752 files, ~238661 lines)
- LICENSE (~21 lines)
- README.md (~161 lines)
- scripts/ (dir, 2 files, ~386 lines)
- SECURITY.md (~40 lines)
- tests/ (dir, 15 files, ~1857 lines)
