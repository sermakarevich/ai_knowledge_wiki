...
## Fix
1. Read ONLY `/Users/sergii/.ai/knowledge/papers/HarnessEngineeringCourse/digest.md` (headlines + key points). Never the source, never full wiki pages, never fleet artifacts.
...
## Tests
- `test -f /Users/sergii/.ai/knowledge/papers/HarnessEngineeringCourse/explainer.md && wc -l /Users/sergii/.ai/knowledge/papers/HarnessEngineeringCourse/explainer.md` >= 60; `grep -c "|" /Users/sergii/.ai/knowledge/papers/HarnessEngineeringCourse/explainer.md` >= 5.
