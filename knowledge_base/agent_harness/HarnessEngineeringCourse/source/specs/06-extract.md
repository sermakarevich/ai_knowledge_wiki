# HarnessEngineeringCourse component 06 extract

## Problem
Write wiki page `wiki/06-gates-course.md` for the `HarnessEngineeringCourse` codebase entry. The worker sees only this spec + the listed repo paths — never the whole repo.
