# HarnessEngineeringCourse component 02 extract

## Problem
Write wiki page `wiki/02-model-seam.md` for the `HarnessEngineeringCourse` codebase entry. The worker sees only this spec + the listed repo paths — never the whole repo.
