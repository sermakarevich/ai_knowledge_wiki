# HarnessEngineeringCourse component 01 extract

## Problem
Write wiki page `wiki/01-agent-core.md` for the `HarnessEngineeringCourse` codebase entry. The worker sees only this spec + the listed repo paths — never the whole repo.
