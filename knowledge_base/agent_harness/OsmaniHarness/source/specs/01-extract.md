...
## Fix
1. Read ONLY `/Users/sergii/.ai/knowledge/papers/OsmaniHarness/source/chunks/01.txt` (plain text, ~5646 chars). If figures are listed below, read those image files too. Do NOT read fleet artifacts/logs, sibling wiki pages, or anything else.
2. Write `/Users/sergii/.ai/knowledge/papers/OsmaniHarness/wiki/01-foundations-behaviour.md` COMPLETELY (overwrite if it exists — retries reuse this spec) following this format contract exactly:
...
## Tests
- `test -f /Users/sergii/.ai/knowledge/papers/OsmaniHarness/wiki/01-foundations-behaviour.md && wc -l /Users/sergii/.ai/knowledge/papers/OsmaniHarness/wiki/01-foundations-behaviour.md` >= 40 lines; `grep -c "^**In one sentence:**" /Users/sergii/.ai/knowledge/papers/OsmaniHarness/wiki/01-foundations-behaviour.md` == 1; `grep -c "^- " /Users/sergii/.ai/knowledge/papers/OsmaniHarness/wiki/01-foundations-behaviour.md` >= 5.
