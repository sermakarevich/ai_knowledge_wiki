...
Read this file in full: `/Users/sergii/.ai/knowledge/research/MetaHarness/source/chunks/01.txt`
...
- `/Users/sergii/.ai/knowledge/research/MetaHarness/wiki/images/fig1-teaser-description.md` — describes `fig1-teaser.png`, the paper's headline results teaser (Figure 1)
- `/Users/sergii/.ai/knowledge/research/MetaHarness/wiki/images/fig2-search-loop-description.md` — describes `fig2-search-loop.png`, the Meta-Harness search-loop schematic (Figure 2)

## Output

Write the file: `/Users/sergii/.ai/knowledge/research/MetaHarness/wiki/01-motivation-and-related-work.md`
