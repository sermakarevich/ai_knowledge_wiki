> PDF location: https://github.com/katipally/openlive (no source.pdf fetched; see Source field below)

# katipally/openlive
Source: https://github.com/katipally/openlive
Kind: repo
Fetched: 2026-09-22T14:28:29.063845+00:00
Tool: git-clone

# katipally/openlive

Commit: 849173cd1c8c17a95d600b17b428c301722bf5df
...
```
{
  ...
  "scripts": {
    "predev": "node scripts/free-ports.mjs --sweep 3000 8787 47824 47823 9333",
    "dev": "concurrently -k --kill-others -n web,agent -c cyan,magenta \"pnpm --filter @openlive/web dev\" \"pnpm --filter @openlive/agent dev\"",
    "stop": "node scripts/free-ports.mjs --sweep 47824 47823 9333 3000 8787",
    "build": "pnpm -r --filter @openlive/web build",
    "db:reset": "pnpm --filter @openlive/db reset",
    "typecheck": "pnpm -r typecheck",
    "test": "vitest run",
    "predesktop:dev": "node scripts/free-ports.mjs --sweep 47824 47823 9333 3000 8787",
...
- .github/ (dir, 6 files, ~279 lines)
- .gitignore (~24 lines)
- apps/ (dir, 120 files, ~12558 lines)
- assets/ (dir, 7 files, ~25 lines)
- CHANGELOG.md (~254 lines)
- CONTRIBUTING.md (~69 lines)
- docs/ (dir, 1 files, ~132 lines)
- LICENSE (~21 lines)
- package.json (~31 lines)
- packages/ (dir, 41 files, ~2977 lines)
- pnpm-lock.yaml (~6892 lines)
- pnpm-workspace.yaml (~34 lines)
- README.md (~191 lines)
- RELEASING.md (~17 lines)
- scripts/ (dir, 1 files, ~86 lines)
- services/ (dir, 36 files, ~4011 lines)
- tsconfig.base.json (~18 lines)
