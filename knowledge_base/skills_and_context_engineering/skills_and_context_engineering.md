...
- [[SignalOrNoiseAgentSkills/summary]] — WebDev-Skills-Bench (31 Skills × 50 projects × 4 models) finds default Skill injection lowers mean Pass@2 on every model and helps only 17–36% of pairs; effect splits into length distraction vs. content misalignment and barely correlates across models — recommends per-task, per-model routing over always-on injection.
